...
<!-- Move items here once complete, newest first. -->
- [x] Add Strange Ceramics to artists.json with 3 processed photos (teapot, chawan trio, full set)
- [x] Swap social plan order: Strange Ceramics → #2 (Thu 7 May), Debra Oldman → #3 (Mon 11 May, awaiting images)
- [x] Replace lorem ipsum bio for Kate Lavender with her catalogue blurb (and remove phone number from public site)
